...
<body>
    <div id="header">
    	<center><br><strong>Student Management System &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    	&nbsp;</strong>Email: <?php echo $_SESSION['email'];?> &nbsp;&nbsp;&nbsp;&nbsp;
    	Name: <?php echo $_SESSION['name'];?>
            <a href="logout.php">&nbsp;&nbsp;&nbsp;&nbsp;Logout</a>
        </center>
    </div>
    <span id="top_span"><marquee>Note:- This portal is open til 10 April... plz edit 
                    ...
                    while($row = mysqli_fetch_assoc($query_run)){
                    	...
                    	<table>
                    		...
                    		<tr>
                    			<td><b>Remark:&nbsp;&nbsp;&nbsp;</b></td>
                    			<td>
                    				<textarea rows="3" cols="40" disabled><?php echo $row
                    				    ['remark'];?></textarea>
                    			</td>
                    		</tr>
                    	</table>
                    ...
                    while($row = mysqli_fetch_assoc($query_run)){
                    	...
                    	<form action="admin_edit_student.php" method="post">
                    		...
                    		<tr>
                    			<td><b>Remark:&nbsp;&nbsp;&nbsp;</b></td>
                    			<td>
                    				<textarea rows="3" cols="40" name="remark"><?php echo $row
                    				    ['remark'];?></textarea>
                    			</td>
                    		</tr><br>
                    		<tr>
